...
class DestinatariosControllerTest < ActionController::TestCase
  ...
  test "should create destinatario" do
    assert_difference('Destinatario.count') do
      post :create, destinatario: { dni: @destinatario.dni, nombre_razon: @destinatario.nombre_razon, ruc: @destinatario.ruc }
    end
  ...
  test "should update destinatario" do
    patch :update, id: @destinatario, destinatario: { dni: @destinatario.dni, nombre_razon: @destinatario.nombre_razon, ruc: @destinatario.ruc }
    assert_redirected_to destinatario_path(assigns(:destinatario))
  end
